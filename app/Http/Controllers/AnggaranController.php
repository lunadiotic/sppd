...
use App\Services\AnggaranServices;
...
class AnggaranController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('pages.anggaran.show', compact('data'));
    }
    ...
    {
        $data = $this->srv->find($id);
        return view('pages.anggaran.edit', compact('data'));
    }
